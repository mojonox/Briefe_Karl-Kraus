...
<xsl:stylesheet 
    ...
    <xsl:param name="directory_name">neu-test</xsl:param>
    <xsl:param name="project_title">Briefe an Karl Kraus</xsl:param>
    <xsl:param name="redmine_id">18716</xsl:param>
    <xsl:param name="project_short_title">Briefe-Kraus</xsl:param>
