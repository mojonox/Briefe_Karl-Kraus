...
## set up GitHub repo
* create a public, new, and empty (without README, .gitignore, license) GitHub repo https://github.com/mojonox/neu-test 
* run `git init` in the root folder of your application neu-test
* execute the commands described under `…or push an existing repository from the command line` in your new created GitHub repo https://github.com/mojonox/neu-test
...
* go to https://https://github.com/mojonox/neu-test/actions/workflows/build.yml
...
* To build the image run: `docker build -f docker/Dockerfile -t neu-test .`
* To run the container: `docker run -p 80:80 --rm --name neu-test neu-test`
